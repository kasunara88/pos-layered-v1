...
public class CustomerPnelView extends javax.swing.JPanel {
     ...
     */
    public CustomerPnelView() throws Exception {
    ...
    private void initComponents() {
        ...
        kGradientPanel2.setkEndColor(new java.awt.Color(126, 182, 230));
        kGradientPanel2.setkGradientFocus(900);
        kGradientPanel2.setkStartColor(new java.awt.Color(210, 155, 233));
    ...
    private void addCustomer() {
        try {
            ...
            Logger.getLogger(CustomerPnelView.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void loaddAllCustomer() throws Exception {
        try {
